...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      {/* Modern Navbar */}
      <nav className="fixed top-0 left-0 right-0 h-16 bg-white/80 backdrop-blur-md border-b border-gray-100 z-50 flex items-center justify-between px-6 lg:px-12">
